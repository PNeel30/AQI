...
mreg = pickle.load(open("Models/Multiple_Regression2.pkl", 'rb'))
preg = pickle.load(open("Models/pregression2.pkl", 'rb'))
dec_tree = pickle.load(open("Models/Decision_tree.pkl", 'rb'))
rt_reg = pickle.load(open("Models/RandomForest2.pkl", 'rb'))
svr_reg = pickle.load(open("Models/svrression2.pkl", 'rb'))
